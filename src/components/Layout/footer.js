import FtrLogo from './Assets/ftrlg.png'
...
const contacts=[
  ...
  </svg>,info:'littlelemon@gmail.com'},]
...
return(
    <>
    <footer>
        <div className="ftr row d-flex justify-content-center  content ">
            <div className="col">
                    <img src={FtrLogo} alt='logos'></img>
            </div>
            <div className="col">
                <h3>SITE MAP</h3>
              <ul>
